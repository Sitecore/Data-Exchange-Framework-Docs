...
copyright = str(datetime.date.today().year) + ', Sitecore'
author = 'Sitecore'
...
htmlhelp_basename = 'data-exchange-framework-docs'
...
latex_documents = [
  ('index', 'data-exchange-framework.tex', 'Data Exchange Framework Documentation',
   'Sitecore', 'manual'),
]
...
man_pages = [
    ('index', 'data-exchange-framework', 'Data Exchange Framework Documentation',
     ['Sitecore'], 1)
]
...
texinfo_documents = [
  ('index', 'data-exchange-framework', 'Data Exchange Framework Documentation',
   'Sitecore', 'data-exchange-framework', 'Data Exchange Framework Documentation',
   'Configuration'),
]
